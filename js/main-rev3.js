...
function handleInputSubmit() {
  ...
  // get preview image, result image, and result text
  var preview = document.getElementById('preview');
  var result = document.getElementById('result');
  var resultText = document.getElementById('result-text');

  // clear preview image, result image, and result text
  ...
  //img.file = file; // seems to work without this on firefox, THIS IS TO IDENTIFY THE FILE LATER SO YOU CAN FETCH IT FOR UPLOAD, NOT NECESSARY HERE
  ...
  // must define function to do onload before passing in a file
  reader.onload = function(e) {img.src = e.target.result;}
  // now you can pass in a file
